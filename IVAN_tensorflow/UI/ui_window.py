...
class ui(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.pushButton_5.clicked.connect(self.deleteline)
    ...
    def run(self):
        ...
        # load tf model
        tf_model = DLDetection.load_tf_model(self.spinBox_2.value(), self.model_path)
        # load svm
        svm = cv2.ml.SVM_load('../interface/vehicle_svm.dat')
